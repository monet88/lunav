...
return destination falling back safely to the private shell, unconfirmed sessions
still blocked from private routes by `Stack.Protected`, and focused unit coverage.
